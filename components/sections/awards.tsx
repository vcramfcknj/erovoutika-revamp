...
import { Award, Trophy, Star, Calendar, Medal } from 'lucide-react'
...
export function Awards() {
  ...
  useEffect(() => { fetchAwards() }, [language])
  ...
  return (
    <section className="py-24 bg-gray-50 dark:bg-slate-800 relative overflow-hidden">
      {/* Orange glow — same as partners */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[900px] h-[500px] bg-orange-50 rounded-full blur-3xl opacity-50" />
      </div>
        ...
        {awards.length === 0 ? (
          ...
          >
            {awards.map((award) => (
              ...
              >
                {/* Orange top accent on hover — matches partner cards */}
                <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-orange-400 to-orange-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                ...
                {award.image_url ? (
                  ...
                  <div className="relative h-48 bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-950/20 dark:to-orange-900/10 flex items-center justify-center overflow-hidden">
                    {/* Decorative rings — same style as partner fallback */}
                ...
                <div className="p-6 flex flex-col flex-1 space-y-3">
                  ...
                  {/* Recipient — orange accent dash, matches partners popup */}
