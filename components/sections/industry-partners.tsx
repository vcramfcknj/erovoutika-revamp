...
import { Globe, Building2, ChevronLeft, ChevronRight, ArrowUpRight, X } from 'lucide-react'
...
export function IndustryPartners() {
  ...
  const fetchPartners = async () => {
    setIsLoading(true)
    try {
      const response = await fetch(`/api/partners/translate?lang=${language}&type=industry`)
